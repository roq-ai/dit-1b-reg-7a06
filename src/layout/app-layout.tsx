...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['teacher', 'school-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Homework', path: '/homework', entity: 'homework', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Schedules', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Semesters', path: '/semesters', entity: 'semester', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    { name: 'Subjects', path: '/subjects', entity: 'subject', service: AccessServiceEnum.PROJECT, icon: FiBook },
