...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`DIT 1B REG`}</title>

        <meta
          name="description"
          content="DIT 1B REG - Simplifying Classroom Management by Digitally Tracking Student Attendance, Ensuring Every Absence and Presence is Accurately Recorded"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjk4NDk5NDkwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`DIT 1B REG - Simplifying Classroom Management by Digitally Tracking Student Attendance, Ensuring Every Absence and Presence is Accurately Recorded`}
            </Text>
            <Box
