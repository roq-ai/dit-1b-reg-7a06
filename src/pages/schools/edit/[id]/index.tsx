        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.number_of_students,
            }}
            name="number_of_students"
            error={formik.errors?.number_of_students}
            value={formik.values?.number_of_students}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('number_of_students', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
