...
import { useRoqClient, useExamFindManyWithCount } from 'lib/roq';
...
export function ExamListPage(props: ExamListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useExamFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.exam.delete({ where: { id } });
      await mutate();
    } catch (error) {
