...
import { useRenamedclassFindFirst, useRoqClient } from 'lib/roq';
...
function RenamedclassViewPage() {
  ...
  const { data, error, isLoading } = useRenamedclassFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Class Subject" text={data?.class_subject} />
