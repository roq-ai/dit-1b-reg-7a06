...
import { useRoqPlatformUserProfiles, useStudentCount, useTeacherCount, useCourseCount } from 'lib/roq';

import { ExamListPage as ShowCaseList } from 'pages/exams';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`exams`} passHref legacyBehavior>
                  <Button
